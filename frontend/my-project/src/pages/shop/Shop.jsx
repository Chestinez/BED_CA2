...
export default function Shop() {
  ...
  const filteredParts = shopData.unowned.filter((part) => {
    ...
    const qualityMatch =
      selectedQuality === "all" || part.quality === selectedQuality;
  ...
  const handlePurchase = async (partId, partName, cost) => {
    ...
    try {
      ...
      const errorMessage =
        error.response?.data?.message || "Failed to purchase part";
            ...
            {filteredParts.length > 0 ? (
              <div className="row">
                {filteredParts.map((part) => {
                  const IconComponent =
                    categoryIcons[part.category] || Settings;
                  const qualityStyle =
                    qualityStyles[part.quality] || qualityStyles.common;
                        ...
                        <div className="card-body d-flex flex-column">
                          ...
                          <div className="d-flex justify-content-between align-items-start mb-3">
                            <div className="d-flex align-items-center">
                              <IconComponent
                                size={24}
                                className={`me-2 ${qualityStyle.textClass}`}
                              />
                            ...
                            <span
                              className={`badge ${qualityStyle.badgeClass}`}
                            >
                          ...
                          <div className="mb-3">
                            <div className="d-flex justify-content-between text-sm">
                              ...
                              <span className={qualityStyle.textClass}>
                                {part.category}
                              </span>
                            </div>
                            <div className="d-flex justify-content-between text-sm">
                          ...
                          <div className="mt-auto">
                            <div className="d-flex justify-content-between align-items-center">
                              ...
                              <button
                                ...
                                onClick={() =>
                                  handlePurchase(part.id, part.name, part.cost)
                                }
                              >
                                {purchasing === part.id ? (
                                  <Settings
                  ...
                  {shopData.owned.slice(0, 6).map((part) => (
                    <div key={part.id} className="col-md-2 mb-2">
                      <div className="text-center">
                        <div
                          className={`badge ${qualityStyles[part.quality]?.badgeClass || "bg-secondary text-white"} mb-1`}
                        >
                          {part.quality}
                        </div>
